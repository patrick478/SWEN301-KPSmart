...
namespace Server.Data
{
    public class Database
    {
        ...
        private Database(string databaseFileName, bool testDatabase)
        {
            ...
            tables.Add("departure_times", "CREATE TABLE 'departure_times' ('id' INTEGER PRIMARY KEY AUTOINCREMENT, 'event_id' INTEGER NOT NULL, 'departure_time_id' INTEGER NOT NULL, 'created' TIMESTAMP DEFAULT (CURRENT_TIMESTAMP) ,'active' INT DEFAULT ('0') , route_id INTEGER NOT NULL, 'weekly_time' TIMESTAMP)");
