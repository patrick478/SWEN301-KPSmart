...
namespace Server.Data
{
    public class Database
    {
        ...
        private Database(string databaseFileName, bool testDatabase)
        {
            ...
            tables.Add("delivery_route_instances", "CREATE TABLE 'delivery_route_instances' ('id' INTEGER PRIMARY KEY AUTOINCREMENT, 'event_id' INTEGER NOT NULL,  'created' TIMESTAMP DEFAULT (CURRENT_TIMESTAMP) ,'active' INT DEFAULT ('0') , delivery_id INTEGER NOT NULL, 'route_id' INTEGER NOT NULL, 'departure_time' TIMESTAMP)");
